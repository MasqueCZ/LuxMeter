...
v = "2.61-19"
version = f" - FIN:0.7s, RON:300s/100%, FOUT:90s, ABL:10%, SOFF:300s"
...
LEVEL1 = 100
FADE2 = 90
HOLD2 = 300 #even when the CORRIDOR won't stop it needs time to know how long to measure
LEVEL2 = 10
FADE3 = 0
HOLD3 = 0
LEVEL3 = 0
...
if OK == True:
    oled.text("OK", 0, 24)
    program_result = "Measurement OK"
    pixels.fill((0, 80 * pix_val, 0))
    pixels.show()
else:
    oled.text("NOK", 0, 24)
    program_result = "Measurement NOK"
