...
program = "42"
v = config.v
version = f" - FIN:0.7s, RON:900s/100%, FOUT:32s, ABL:50%, HOLD2:900s, FOUT:32s, 10%, SOFF:/"
...
LEVEL1 = 100
FADE2 = 32
HOLD2 = 900 #even when the CORRIDOR won't stop it needs time to know how long to measure
LEVEL2 = 50
FADE3 = 32
HOLD3 = 60
LEVEL3 = 10
