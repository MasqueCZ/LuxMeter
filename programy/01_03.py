...
v = "1.4-03"
version = f"{v} - 03 FIN:0.7s, RON:150s/72%, FOUT:30s, ABL:10%, SOFF:/"
...
72% nastaveno jako 100 a 10 jako  7.2% - nevím jak to jinak teď rychle obejít když si zákazník atypicky nastavuje sv. fcí CORRIDOR
"""
DEBUG = False #If TRUE, program shows extra data in shell

FADE1 = 0.7
HOLD1 = 150
LEVEL1 = 100 # 72% - nevím jak to jinak teď rychle obejít když si zákazník atypicky nastavuje sv. fcí CORRIDOR
FADE2 = 30
